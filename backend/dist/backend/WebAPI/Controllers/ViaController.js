...
export class ViaController {
     ...
     * @returns {Error} 500 - Erro desconhecido
     */
    createVia = async (requisicao, resposta) => {
        try {
     ...
     * @returns {Error} 500 - Erro desconhecido
     */
    updateVia = async (requisicao, resposta) => {
        try {
            const via = requisicao.body;
     ...
     * @returns {object} 404 - Via não encontrada
     */
    deleteVia = async (requisicao, resposta) => {
        try {
    ...
    /**
     * @route GET /vias/colecao/:colecaoId
     * @group Vias - Operações relacionadas a vias
     * @returns {Array.<Via>} 200 - Vias encontradas
     * @returns {object} 404 - Via não encontrada
     * @returns {Error} 500 - Erro desconhecido
     */
    getViasInColecao = async (req, res) => {
        try {
