...
const colecoes_json_1 = __importDefault(require("../../../database/json/colecoes.json"));
async function loadData() {
    ...
    try {
        ...
        const colecaoRepository = queryRunner.manager.getRepository(Colecao_1.Colecao);
        ...
        const colecoes = colecaoRepository.create(colecoes_json_1.default.colecoes);
